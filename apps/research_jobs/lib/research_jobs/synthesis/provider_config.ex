defmodule ResearchJobs.Synthesis.ProviderConfig do
  @moduledoc """
  Reads synthesis provider configuration from application config.
  """
  ...
  defp normalize(options) do
    ...
    %{
      ...
      llm: %{
        ...
        temperature: Keyword.get(llm_options, :temperature, 0.2)
      }
    }
  end
end
